...
class RDTLayer(object):
    ...
    def deliver_data(self):
        ...
        str = ""
        for seqnum in sorted(self.dictReceived):
            str += self.dictReceived[seqnum]
    ...
    def getCumAck(self):
        ...
        # YOUR CODE HERE:
        #a = 0
        #for i in list(self.dictReceived.keys()):
        print ("getCumAck")
            #print ("i: ", i)
            #print ("a: ", a)
         #   if a != i:
          #      break
           # a = a + self.DATA_LENGTH
        #return a
        #print ("check dictReceived: ", self.dictReceived)
        keys = 0
        while (True):
            if keys not in self.dictReceived:
                return keys
            else:
                 keys += self.DATA_LENGTH
    ...
    def manageSegmentTimeouts(self):
        ...
        copy = dict(self.dictSent)
        for seqnum in copy:
            if(self.currentIteration - self.dictSent[seqnum].startIteration) > RDTLayer.MAX_ITERATIONS_SEGMENT_TIMEOUT:
                del self.dictSent[seqnum]
    ...
    def rdt_send(self):
        ...
        while seqnum <= self.sendWinStart + self.FLOW_CONTROL_WIN_SIZE:
		...
		#this part is handled in the while loop	
    ...
    def rdt_recv(self):
        ...
        for seg in listIncoming: 
            ...
            if seg.seqnum >= 0:
                ...
                #self.dictReceived.append(seg.payload)
